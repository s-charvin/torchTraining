...
if __name__ == "__main__":
    ...
    # convnext_tiny mult-adds (M):  0.38  params (M): 28,589,128
    model = convnext_tiny()
    output = model(input)
    print("\n\nmodel: convnext_tiny")
    ...
    # convnext_small mult-adds (M):  0.82  params (M): 50,223,688
    ...
    # convnext_base mult-adds (M):  1.29  params (M): 88,591,464
    model = convnext_base()
    output = model(input)
    print("\n\nmodel: convnext_base")
    print("input shape: ", input.shape)
    ...
    # convnext_large mult-adds (M):  2.53  params (M): 197,767,336
    ...
    # convnext_xlarge mult-adds (M):  4.15  params (M): 350,196,968
