...
class RevViT(nn.Module):
    def __init__(
        ...
        patch_size=(
            2,
            2,
        ),  # this patch size is used for CIFAR-10 # --> (32 // 2)**2 = 256 sequence length
        ...
        # Reversible blocks 的使用可以像 vanilla blocks 一样, 因为任何 reversible bacpropagation 的操作都在 block 代码中.
        ...
        # 控制 vanilla backprop 和 rev backprop方法的切换, 对应参数: ``vanilla_bp``
        ...
        # The two streams are concatenated and passed through a linear layer for final projection. This is the only part of RevViT that uses different parameters/FLOPs than a standard ViT model.
        # Note that fusion can be done in several ways, including more expressive methods like in paper, but we use linear layer + LN for simplicity.
