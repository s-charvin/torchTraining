...
class ReparamLargeKernelConv(nn.Module):
    ...
    def get_equivalent_kernel_bias(self):
        ...
        if hasattr(self, 'small_conv'):
            ...
            eq_k += nn.functional.pad(small_k,
...
class ConvFFN(nn.Module):
    ...
    def __init__(self, in_channels, internal_channels, out_channels, drop_path):
        ...
        self.pw1 = conv_bn(in_channels=in_channels, out_channels=internal_channels,
                           kernel_size=1, stride=1, padding=0, groups=1)
        self.pw2 = conv_bn(in_channels=internal_channels, out_channels=out_channels,
                           kernel_size=1, stride=1, padding=0, groups=1)
...
class RepLKNetStage(nn.Module):
    ...
    def __init__(self, channels, num_blocks, stage_lk_size, drop_path,
        ...
        for i in range(num_blocks):
            block_drop_path = drop_path[i] if isinstance(
